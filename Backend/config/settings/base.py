...
GOOGLE_MERCHANT_SHEETS_SYNC_ENABLED = env.bool('GOOGLE_MERCHANT_SHEETS_SYNC_ENABLED', default=False)
GOOGLE_MERCHANT_SHEETS_SPREADSHEET_ID = env('GOOGLE_MERCHANT_SHEETS_SPREADSHEET_ID', default='')
GOOGLE_MERCHANT_SHEETS_RANGE = env('GOOGLE_MERCHANT_SHEETS_RANGE', default='Sheet1!A1:AN')
GOOGLE_MERCHANT_SHEETS_CLEAR_RANGE = env('GOOGLE_MERCHANT_SHEETS_CLEAR_RANGE', default='Sheet1!A:AN')

if GOOGLE_MERCHANT_SHEETS_SYNC_ENABLED and GOOGLE_MERCHANT_SHEETS_SPREADSHEET_ID:
    CELERY_BEAT_SCHEDULE['refresh-google-merchant-sheet-daily'] = {
        'task': 'apps.integrations.tasks.refresh_google_merchant_sheet',
...
GOOGLE_MERCHANT_FEED_TOKEN = env('GOOGLE_MERCHANT_FEED_TOKEN', default='')
