...
from .accounting_views import (
    AdminAccountingAccountCollectionAPIView,
    AdminAccountingBankTransactionCollectionAPIView,
    AdminAccountingBankTransactionCsvImportAPIView,
    AdminAccountingBankTransactionDetailAPIView,
    AdminAccountingGeneralLedgerAPIView,
    AdminAccountingJournalCollectionAPIView,
    AdminAccountingJournalDetailAPIView,
    AdminAccountingPaymentLedgerAPIView,
    AdminAccountingReconciliationAllocationCollectionAPIView,
    AdminAccountingReconciliationCandidatesAPIView,
    AdminAccountingTrialBalanceAPIView,
)
from .admin_extra_views import (
    ...
    AdminDistanceDeliveryMethodCollectionAPIView,
    AdminDistanceDeliveryMethodDetailAPIView,
...
from .integration_views import (
    ...
    GoogleMerchantSheetLogAPIView,
    GoogleMerchantSheetSyncAPIView,
...
from .payment_config_views import (
    AdminFinanceOrderDetailAPIView,
    AdminFinancePayoutBatchCSVAPIView,
    AdminFinancePayoutBatchCollectionAPIView,
    AdminFinancePayoutBatchDetailAPIView,
    AdminFinancePayoutBatchStatusAPIView,
    AdminFinanceReconciliationCollectionAPIView,
    AdminFinanceReconciliationDetailAPIView,
    AdminFinanceRefundLedgerCollectionAPIView,
    AdminFinanceRefundLedgerDetailAPIView,
    AdminFinanceReturnCaseCollectionAPIView,
    AdminFinanceReturnCaseDetailAPIView,
    AdminFinanceSummaryAPIView,
    AdminFinanceSupplierPayableCollectionAPIView,
    AdminCodMpesaPromptAPIView,
    AdminPaymentConfigurationAPIView,
    AdminPaymentCancelAPIView,
    AdminPaymentRefundAPIView,
    AdminPaymentVerifyReceivedAPIView,
    AdminPaymentSessionLogCollectionAPIView,
    AdminPesapalRegisterIPNAPIView,
)
...
from .supplier_views import (
    ...
    SupplierOfferModerationCollectionAPIView,
    SupplierOfferModerationDetailAPIView,
    SupplierOrderCollectionAPIView,
    SupplierOrderDetailAPIView,
    SupplierOrderLineStatusAPIView,
    SupplierProductOfferCollectionAPIView,
    SupplierProductOfferDetailAPIView,
    ...
    SupplierProductRequestCollectionAPIView,
    SupplierProductRequestModerationCollectionAPIView,
    SupplierProductRequestModerationDetailAPIView,
...
urlpatterns = [
    ...
    path('account/recently-bought/', RecentlyBoughtAPIView.as_view(), name='account-recently-bought'),
    ...
    path('supplier/offers/', SupplierProductOfferCollectionAPIView.as_view(), name='supplier-offers'),
    path('supplier/offers/<int:offer_id>/', SupplierProductOfferDetailAPIView.as_view(), name='supplier-offer-detail'),
    path('supplier/product-requests/', SupplierProductRequestCollectionAPIView.as_view(), name='supplier-product-requests'),
    ...
    path('admin/supplier-offers/', SupplierOfferModerationCollectionAPIView.as_view(), name='admin-supplier-offers'),
    path('admin/supplier-offers/<int:offer_id>/', SupplierOfferModerationDetailAPIView.as_view(), name='admin-supplier-offer-detail'),
    path('admin/supplier-product-requests/', SupplierProductRequestModerationCollectionAPIView.as_view(), name='admin-supplier-product-requests'),
    path('admin/supplier-product-requests/<int:request_id>/', SupplierProductRequestModerationDetailAPIView.as_view(), name='admin-supplier-product-request-detail'),
    ...
    path('admin/media/<str:image_id>/', AdminMediaDetailAPIView.as_view(), name='admin-media-detail'),
    ...
    path('admin/finance/summary/', AdminFinanceSummaryAPIView.as_view(), name='admin-finance-summary'),
    path('admin/finance/reconciliation/', AdminFinanceReconciliationCollectionAPIView.as_view(), name='admin-finance-reconciliation'),
    path('admin/finance/reconciliation/<int:reconciliation_id>/', AdminFinanceReconciliationDetailAPIView.as_view(), name='admin-finance-reconciliation-detail'),
    path('admin/finance/supplier-payables/', AdminFinanceSupplierPayableCollectionAPIView.as_view(), name='admin-finance-supplier-payables'),
    path('admin/finance/refunds/', AdminFinanceRefundLedgerCollectionAPIView.as_view(), name='admin-finance-refunds'),
    path('admin/finance/refunds/<int:refund_id>/', AdminFinanceRefundLedgerDetailAPIView.as_view(), name='admin-finance-refund-detail'),
    path('admin/finance/returns/', AdminFinanceReturnCaseCollectionAPIView.as_view(), name='admin-finance-returns'),
    path('admin/finance/returns/<int:return_id>/', AdminFinanceReturnCaseDetailAPIView.as_view(), name='admin-finance-return-detail'),
    path('admin/finance/orders/<str:order_number>/', AdminFinanceOrderDetailAPIView.as_view(), name='admin-finance-order-detail'),
    path('admin/finance/payout-batches/', AdminFinancePayoutBatchCollectionAPIView.as_view(), name='admin-finance-payout-batches'),
    path('admin/finance/payout-batches/<int:batch_id>/', AdminFinancePayoutBatchDetailAPIView.as_view(), name='admin-finance-payout-batch-detail'),
    path('admin/finance/payout-batches/<int:batch_id>/csv/', AdminFinancePayoutBatchCSVAPIView.as_view(), name='admin-finance-payout-batch-csv'),
    path('admin/finance/payout-batches/<int:batch_id>/<str:action>/', AdminFinancePayoutBatchStatusAPIView.as_view(), name='admin-finance-payout-batch-status'),
    path('admin/accounting/accounts/', AdminAccountingAccountCollectionAPIView.as_view(), name='admin-accounting-accounts'),
    path('admin/accounting/journals/', AdminAccountingJournalCollectionAPIView.as_view(), name='admin-accounting-journals'),
    path('admin/accounting/journals/<int:journal_id>/', AdminAccountingJournalDetailAPIView.as_view(), name='admin-accounting-journal-detail'),
    path('admin/accounting/general-ledger/', AdminAccountingGeneralLedgerAPIView.as_view(), name='admin-accounting-general-ledger'),
    path('admin/accounting/payment-ledger/', AdminAccountingPaymentLedgerAPIView.as_view(), name='admin-accounting-payment-ledger'),
    path('admin/accounting/trial-balance/', AdminAccountingTrialBalanceAPIView.as_view(), name='admin-accounting-trial-balance'),
    path('admin/accounting/bank-transactions/', AdminAccountingBankTransactionCollectionAPIView.as_view(), name='admin-accounting-bank-transactions'),
    path('admin/accounting/bank-transactions/import/', AdminAccountingBankTransactionCsvImportAPIView.as_view(), name='admin-accounting-bank-transactions-import'),
    path('admin/accounting/bank-transactions/<int:transaction_id>/<str:action>/', AdminAccountingBankTransactionDetailAPIView.as_view(), name='admin-accounting-bank-transaction-action'),
    path('admin/accounting/reconciliation/candidates/', AdminAccountingReconciliationCandidatesAPIView.as_view(), name='admin-accounting-reconciliation-candidates'),
    path('admin/accounting/reconciliation/allocations/', AdminAccountingReconciliationAllocationCollectionAPIView.as_view(), name='admin-accounting-reconciliation-allocations'),
    ...
    path('admin/payments/<str:reference>/cancel/', AdminPaymentCancelAPIView.as_view(), name='admin-payment-cancel'),
    path('admin/payments/<str:reference>/verify-received/', AdminPaymentVerifyReceivedAPIView.as_view(), name='admin-payment-verify-received'),
    path('admin/payments/<str:reference>/refund/', AdminPaymentRefundAPIView.as_view(), name='admin-payment-refund'),
    path('admin/orders/<str:order_number>/cod/mpesa-prompt/', AdminCodMpesaPromptAPIView.as_view(), name='admin-order-cod-mpesa-prompt'),
    ...
    path('admin/shipping/distance/', AdminDistanceDeliveryMethodCollectionAPIView.as_view(), name='admin-shipping-distance'),
    path('admin/shipping/distance/<int:method_id>/', AdminDistanceDeliveryMethodDetailAPIView.as_view(), name='admin-shipping-distance-detail'),
    ...
    path('admin/integrations/google-merchant/sheets/logs/', GoogleMerchantSheetLogAPIView.as_view(), name='admin-google-merchant-sheets-logs'),
    path('admin/integrations/google-merchant/sheets/sync/', GoogleMerchantSheetSyncAPIView.as_view(), name='admin-google-merchant-sheets-sync'),
    ...
    path('checkout/places/search/', DeliveryPlaceSearchAPIView.as_view(), name='checkout-places-search'),
    ...
    path('checkout/payments/high-value-deposit/', HighValueBankDepositAPIView.as_view(), name='checkout-payment-high-value-deposit'),
