        ...
        'sections': [
            ...
            },
            {
                ...
                'endpoints': [
                    ...
                    {'method': 'POST', 'path': f'{base_url}/admin/integrations/', 'auth': 'staff session', 'description': 'Create an ERP/integration connection.'},
                    {'method': 'PATCH', 'path': f'{base_url}/admin/integrations/<connection_id>/', 'auth': 'staff session', 'description': 'Update an ERP/integration connection.'},
