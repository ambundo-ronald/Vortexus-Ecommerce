...
ALLOWED_STOREFRONT_ANALYTICS_EVENTS = {
    ...
    'storefront.checkout_cart_viewed',
    'storefront.checkout_started',
    'storefront.shipping_started',
    'storefront.shipping_address_form_started',
    'storefront.shipping_new_address_started',
    'storefront.location_current_requested',
    'storefront.location_current_failed',
    'storefront.location_search_started',
    'storefront.location_search_results',
    'storefront.location_search_failed',
    'storefront.location_pinned',
    'storefront.location_pin_failed',
    'storefront.shipping_save_attempted',
    'storefront.shipping_confirmed',
    'storefront.shipping_saved',
    'storefront.shipping_save_failed',
    'storefront.shipping_save_blocked',
    'storefront.saved_shipping_selected',
    'storefront.saved_shipping_used',
    'storefront.saved_shipping_failed',
    'storefront.saved_shipping_missing_pin',
    'storefront.shipping_method_selected',
    'storefront.shipping_method_failed',
    'storefront.shipping_continue_clicked',
    'storefront.checkout_high_value_quote_required',
    'storefront.checkout_high_value_quote_sent',
    'storefront.checkout_high_value_quote_failed',
    'storefront.payment_started',
    'storefront.payment_method_selected',
    'storefront.payment_blocked_checkout_incomplete',
    'storefront.payment_initialized',
    'storefront.payment_prompt_sent',
    'storefront.payment_prompt_failed',
    'storefront.payment_prompt_retry',
    'storefront.payment_redirect_started',
    'storefront.payment_confirmed',
    'storefront.payment_failed',
    'storefront.payment_timeout',
    'storefront.payment_status_checked',
    'storefront.payment_continue_to_review',
    'storefront.review_viewed',
    'storefront.review_payment_status_checked',
    'storefront.order_place_clicked',
    'storefront.order_place_blocked',
    'storefront.order_placed',
    'storefront.order_place_failed',
